<template>
    <div
        class="w-full sticky top-0 left-0 right-0 z-10 py-2 bg-white/70 md:bg-[#f5f5f7]/70"
    >
        <div
            class="flex items-center justify-between main-container px-5 gap-16"
        >
            ...
            >
                ...
                <div class="flex items-center gap-4">
                    <button class="p-2.5 text-font hover:text-black">
                        Login
                    </button>
                    <div>
            ...
            <button
                ...
                class="*:text-primary custom:hidden"
            >
